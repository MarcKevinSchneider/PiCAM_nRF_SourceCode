/*
 * Script Function: Handles the GPS configuration of the nRF. In the current version, no GPS is included.
 *                  However, the script is still included for compatability.
 *
